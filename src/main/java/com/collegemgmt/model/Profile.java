...
public class Profile {
	...
	private Integer counterSigningManagerId;
	...
	public Integer getCounterSigningManagerId() {
		return counterSigningManagerId;
	}

	public void setCounterSigningManagerId(Integer counterSigningManagerId) {
