...
import com.collegemgmt.services.InventoryServices;
...
public class InventoryController {
	...
	public ResponseEntity< List<Inventory>>getInventory() throws collegemgmtBaseException{
	...
	public ResponseEntity<IAMResponse>addInventory(@RequestBody Inventory inventory) throws collegemgmtBaseException
	{
	...
	public ResponseEntity<IAMResponse> editInventory(@RequestBody Inventory inventory) throws collegemgmtBaseException
	{
	...
	public ResponseEntity<IAMResponse> deleteInventory(@RequestBody Inventory inventory) throws collegemgmtBaseException
	{
